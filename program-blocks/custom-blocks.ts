...
import {depth_detector_blocks, display_on_face_blocks, face_detector_blocks, sound_detector_blocks, speech_recognition_blocks, tts_blocks} from "./detectors-blocks";
...
export function customBlockDefinition() {
    ...
    Blockly.common.defineBlocks(display_on_face_blocks);
    Blockly.common.defineBlocks(face_detector_blocks);
    Blockly.common.defineBlocks(depth_detector_blocks);
    Blockly.common.defineBlocks(sound_detector_blocks);
